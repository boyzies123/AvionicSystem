 ...
 */
/**.
 * Class of attitude sensor, managing attitude of aircraft
 */
public class AttitudeSensor extends Sensor {
  ...
  /**.
   * Constructor of attitude sensor, consisting of the current
   * pitch, yaw and roll
   */
  ...
  /**.
   * Sends the sensor data based on attributes of airspeed sensor
   *
  ...
  /**.
   * Gets the current pitch reported by the attitude sensor
   *
  ...
  /**.
   * Gets the current roll reported by the attitude sensor
   *
  ...
  /**.
   * Gets the current yaw reported by the attitude sensor
   *
  ...
  /**.
   * Gets the maximum yaw reported by the attitude sensor
   *
  ...
  /**.
   * Gets the maximum roll reported by the attitude sensor
   *
  ...
  /**.
   * Gets the maximum pitch reported by the attitude sensor
   *
  ...
  /**.
   * Gets the minimum yaw reported by the attitude sensor
   *
  ...
  /**.
   * Gets the minimum roll reported by the attitude sensor
   *
  ...
  /**.
   * Gets the minimum pitch reported by the attitude sensor
   *
